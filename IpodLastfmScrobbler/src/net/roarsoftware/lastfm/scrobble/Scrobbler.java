...
public class Scrobbler {
	...
	public ResponseStatus submit(TrackItem ipodTrack) throws IOException {
		//String artist, String track, String album, int length, int tracknumber, Source source, long startTime
		
		SubmissionData data = new SubmissionData(ipodTrack.getArtist() , ipodTrack.getTrack() , ipodTrack.getAlbum() , (int)ipodTrack.getLength() , (int)ipodTrack.getTrackid() , Source.USER , ipodTrack.getStartTime());
